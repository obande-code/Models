...
<div class="d-flex justify-content-center flex-wrap">
  ...
  <div class=" w-75 d-flex model_img_mobile mt-1 row">
    <img src="{{ asset('image/download (52).png') }}" class="col-lg-4 col-6 p-0" alt="">
    <img src="{{ asset('image/download (53).png') }}" class="col-lg-4 col-6 p-0" alt="">
    <img src="{{ asset('image/download (54).png') }}" class="col-lg-4 col-6 p-0" alt="">
    <img src="{{ asset('image/download (52).png') }}" class="col-lg-4 col-6 p-0" alt="">
    <img src="{{ asset('image/download (53).png') }}" class="col-lg-4 col-6 p-0" alt="">
    <img src="{{ asset('image/download (54).png') }}" class="col-lg-4 col-6 p-0" alt="">
    <img src="{{ asset('image/download (52).png') }}" class="col-lg-4 col-6 p-0" alt="">
