...
<div class="d-flex justify-content-center flex-column flex-wrap">
    ...
    <div class="position-relative">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer d-flex justify-content-center">
                        ...
                        <a href="{{ url('deladvertise/' . $post->path) }}" type="button"
        ...
        <div id="{{substr($post->path, 0, 10)}}" onclick="editremove({{substr($post->path, 0, 10)}})"
            ...
            <div class="mt-4">
                ...
                <a href="{{ url('editadvertise/' . $post->path) }}" class="btn btn-primary rounded-circle p-2 mx-2">
    ...
    @endforeach
    <a class="btn btn-danger login_button fixed-bottom btn_addpost w-100" href="/newadvertise">Add New</a>
</div>
<script>
