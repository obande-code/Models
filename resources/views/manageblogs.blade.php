...
<div class="d-flex justify-content-center flex-column flex-wrap">
    ...
    <div class="position-relative">
        <div class="d-flex justify-content-between mt-3 pb-2 post_item"
            onclick="editshowClick({{substr($post->image, 0, 10)}})">
            <div class="d-flex flex-column justify-content-center img-contain">
                <img src="{{asset('storage/uploads/' .$post->image. '')}}" alt="" class="mx-3 rounded post_img">
            </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer d-flex justify-content-center">
                        ...
                        <a href="{{ url('delblog/' . $post->image) }}" type="button"
                            class="btn btn-success rounded-pill btn-sm w-25">Yes</a>
                    </div>
                </div>
            </div>
        </div>
        <div id="{{substr($post->image, 0, 10)}}" onclick="editremove({{substr($post->image, 0, 10)}})"
            ...
            <div class="mt-4">
                ...
                <a href="{{ url('editblog/' . $post->image) }}" class="btn btn-primary rounded-circle p-2 mx-2">
    ...
    @endforeach
    <a class="btn btn-danger login_button fixed-bottom btn_addpost w-100" href="/newblog">Add New</a>
</div>
<script>
