            ...
            <div class="col-md-8 col-md-offset-3">
               <div class="panel panel-default credit-card-box">
                  ...
                  <div class="panel-body">
                     ...
                     @endif
                     <br>
                     <form role="form" action="{{ route('videostripe.post') }}" method="post" class="require-validation" data-cc-on-file="false" data-stripe-publishable-key="{{ env('STRIPE_KEY') }}" id="payment-form" style="border: 1px solid grey; padding: 10px">
                        @csrf
                        <input type="text" name="amount" value="{{$amount}}" class="subscriptionfee">
                        <input type="text" name="video" value="{{$video}}" id="video" class="subscriptionfee video">
                        <h3>{{$amount}} - Premium Video({{$amount}})</h3>
                           <p class="mb-0">This payment is for {{(int)substr($amount, 1)*1.06}} incl.6% Transaction Fee.</p>
                           <p>Followed by payment for {{(int)substr($amount, 1)*1.06}} incl.6% Transaction Fee every 30 days until canceled.</p>
                        ...
                        <div class='form-row row'>
                           ...
                           <div class='col-xs-12 col-md-4 form-group expiration required'>
                              ...
                              <input class='form-control card-expiry-month' placeholder='MM' required size='2' type='text'>
                           </div>
                           <div class='col-xs-12 col-md-4 form-group expiration required'>
                              <label class='control-label'>Expiration Year</label> 
                              <input class='form-control card-expiry-year' placeholder='YYYY' required size='4' type='text'>
                           </div>
                        </div>
                        <div class="form-row row">
